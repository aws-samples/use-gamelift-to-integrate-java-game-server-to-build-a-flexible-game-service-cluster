...
aws gamelift upload-build --operating-system AMAZON_LINUX_2 --build-root ./ServerBuild/ --name "Java Game Server Example" --build-version $buildversion --region $region